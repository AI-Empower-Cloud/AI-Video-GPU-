...
export default function Footer() {
  return (
    <footer className="glass backdrop-blur-md border-t border-white/20 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2 text-navy-600">
                  ...
                  <span className="text-sm">contact@aivideogpu.com</span>
                </div>
                <div className="flex items-center space-x-2 text-navy-600">
          ...
          {Object.entries(footerLinks).map(([category, links], index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-navy-800 font-semibold mb-4 capitalize">
                {category}
              </h3>
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-navy-600 hover:text-navy-800 transition-colors duration-200 text-sm"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        >
          <p className="text-navy-600 text-sm mb-4 md:mb-0">
            © 2024 AI Empower Hub. All rights reserved.
          </p>
